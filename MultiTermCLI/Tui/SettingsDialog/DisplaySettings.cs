...
public class DisplaySettings : View {

    public HexSettings Settings { get; private set; }
    ...
    public DisplaySettings(HexSettings displaySettings) : base() {
        ...
        this.HexFormats.SelectedItemChanged += (object? sender, SelectedItemChangedArgs args) => {
            switch (this.HexFormats.SelectedItem) {
